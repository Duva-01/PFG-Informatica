...
Future<List<NewsArticle>> obtenerNoticiasDeAcciones(String nombreAccion, String idioma) async {
...
Future<List<NewsArticle>> _intentarSolicitud(Uri url, {int reintentos = 10}) async {
  int intentos = 0;
