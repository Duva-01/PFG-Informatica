...
const String baseUrl = 'http://10.0.2.2:5000'; // URL base para las solicitudes al servidor

// Función asincrónica para obtener la cartera del usuario
Future<Map<String, dynamic>> obtenerCartera(String userEmail) async {
...
Future<bool> depositarCartera(String userEmail, double cantidad) async {
...
Future<bool> retirarCartera(String userEmail, double cantidad) async {
...
Future<bool> comprarAccion(String userEmail, String symbol, double precio, int cantidad) async {
...
Future<bool> venderAccion(String userEmail, String symbol, double precio, int cantidad) async {
...
Future<List<dynamic>> obtenerTransaccionesUsuario(String userEmail) async {
...
Future<double> calcularBeneficio(String userEmail) async {
