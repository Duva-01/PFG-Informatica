            ...
            child: IntrinsicHeight(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    controller:
                        _controladorContrasena, // Asignar el controlador al campo de contraseña
                    decoration: InputDecoration(
                      labelText:
                          'Contraseña', // Etiqueta del campo de contraseña
                      border:
                          OutlineInputBorder(), // Borde del campo de entrada
                      suffixIcon: Icon(Icons
                          .visibility_off), // Icono para ocultar la contraseña
                    ),
                  ...
                  TextButton(
                    ...
                    child: Text(
                        'Saltar'), // Texto del botón para registrarse
                    onPressed: () {
                      Navigator.of(context).pushNamed(
